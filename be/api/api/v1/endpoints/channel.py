...
from api.api.dependencies import get_current_user, get_channel_service
from api.models import Channel, Consumer
from api.schemas import ChannelDTO
from api.schemas.responses import ChannelsResponse, BaseResponse
